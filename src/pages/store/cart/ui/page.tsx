...
const Cart: FC = () => {
  ...
  return (
    <section className="min-h-screen p-3 sm:p-20 flex flex-col justify-center gap-20">
      ...
      <div>
        <Link to={loaderData.token ? '/checkout' : '/signin?from=cart' } className="w-30 h-10 mx-auto outline-offset-3 rounded-full cursor-pointer flex items-center justify-center bg-black text-white">
          Checkout
        </Link>
      </div>
    </section>
